...
#define HAVE_paired_madds0 (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD)
#define HAVE_paired_madds1 (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD)
#define HAVE_paired_madd (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD)
#define HAVE_paired_msub (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD)
#define HAVE_paired_nmadd (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD \
   && HONOR_SIGNED_ZEROS (SFmode))
#define HAVE_paired_nmsub (TARGET_PAIRED_FLOAT && TARGET_FUSED_MADD \
   && HONOR_SIGNED_ZEROS (DFmode))
...
#define HAVE_fixuns_truncsfsi2 (TARGET_HARD_FLOAT && !TARGET_FPRS && TARGET_SINGLE_FLOAT)
#define HAVE_fix_truncsfsi2 (TARGET_HARD_FLOAT && !TARGET_FPRS && TARGET_SINGLE_FLOAT)
#define HAVE_fixuns_truncdfsi2 (TARGET_HARD_FLOAT && TARGET_E500_DOUBLE)
#define HAVE_fixuns_truncdfdi2 (TARGET_HARD_FLOAT && TARGET_VSX)
#define HAVE_floatsidf2 (TARGET_HARD_FLOAT  \
   && ((TARGET_FPRS && TARGET_DOUBLE_FLOAT) || TARGET_E500_DOUBLE))
#define HAVE_floatunssisf2 (TARGET_HARD_FLOAT && !TARGET_FPRS && TARGET_SINGLE_FLOAT)
...
#define HAVE_floatsisf2 (TARGET_HARD_FLOAT && !TARGET_FPRS)
...
extern rtx        gen_paired_madd                       (rtx, rtx, rtx, rtx);
extern rtx        gen_paired_msub                       (rtx, rtx, rtx, rtx);
extern rtx        gen_paired_nmadd                      (rtx, rtx, rtx, rtx);
extern rtx        gen_paired_nmsub                      (rtx, rtx, rtx, rtx);
